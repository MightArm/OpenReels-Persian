...
|-----------|-----------|---------|
| **LLM** | Anthropic Claude, OpenAI GPT, Google Gemini, OpenRouter, OmniRoute, any OpenAI-compatible | `ANTHROPIC_API_KEY`, `OPENAI_API_KEY`, `GOOGLE_API_KEY`, `OPENROUTER_API_KEY`, `OMNIROUTE_API_KEY`, `OPENREELS_LLM_API_KEY` |
...
| **Images** | Gemini Imagen, OpenAI DALL-E, OmniRoute (AI Horde, free) | `GOOGLE_API_KEY`, `OPENAI_API_KEY`, `OMNIROUTE_API_KEY` |
